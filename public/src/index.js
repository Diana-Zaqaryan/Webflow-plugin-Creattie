...
document.addEventListener("DOMContentLoaded", () => {
    lottie.loadAnimation({
        container: document.getElementById("animation-container"), // Target the div
        renderer: "svg", // Render as SVG (or "canvas", "html")
        loop: true, // Set true for infinite looping
        autoplay: true, // Play automatically
        path: 'animationPath', // Load animation JSON from URL
    });
});
...
const addAsset = () => __awaiter(void 0, void 0, void 0, function* () {
